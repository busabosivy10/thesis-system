		...
		<div class="container admin-container" v-if="$store.state.isAdminLoggedIn">
			<div class="left-nav">
				<ul>
					...
					<li v-if="$store.state.decodedAdminToken.adminFor == 'All'"><router-link to="/admin-panel/add-account"><i class="fa fa-users" aria-hidden="true"></i> Add User</router-link></li>
